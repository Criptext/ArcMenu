...
public class ArcLayout extends ViewGroup {
	...
	private final float centerFactor = 0.9030f; 
    ...
    private static int computeRadius(final float arcDegrees, final int childCount, final int childSize,
        ...
        final int radius = (int) (perSize*1.75);
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        final int centerX = (int) (getWidth()*centerFactor);
        final int centerY = (int) (getHeight()*centerFactor);
        buttonX = getHeight();
        buttonY = getWidth();
    ...
    @SuppressLint("NewApi") private void bindChildAnimation(final View child, final int index, final long duration) {
